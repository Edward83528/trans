...
public class ProgramList {
	...
	private String OD_STATIONSERNO; // 分臺代碼

	private String OD_PROGRAMSERNO; // 聯播節目設定

	private String OD_ADMINUID; // 節目管理人代碼

	private String adminName; // 節目管理人名稱

	private String OD_PROGRAMlINK; // 節目內容轉址

	private String OD_WEEK; // 時間

	private String OD_STARTTIME; // 節目開始時段

	private String OD_ENDTIME; // 節目結束時段

	private String OD_HOSTNAME; // 主持人名稱

	private String OD_HOSTIMGCLIENTFILE; // 主持人封面圖原始檔名

	private String OD_HOSTIMGSERVERFILE; // 主持人封面圖主機檔名

	private String OD_HOSTFB; // 主持人FB

	private String OD_HOSTFANGROUP; // 主持人粉絲團

	private String OD_DETAILCONTENT; // 主持人介紹(心情小語)
	...
	public String getOD_PROGRAMSERNO() {
		return OD_PROGRAMSERNO;
	}

	public void setOD_PROGRAMSERNO(String oD_PROGRAMSERNO) {
		OD_PROGRAMSERNO = oD_PROGRAMSERNO;
	}

	public String getOD_ADMINUID() {
		return OD_ADMINUID;
	}

	public void setOD_ADMINUID(String oD_ADMINUID) {
		OD_ADMINUID = oD_ADMINUID;
	}
	...
	public String getOD_PROGRAMlINK() {
		return OD_PROGRAMlINK;
	}

	public void setOD_PROGRAMlINK(String oD_PROGRAMlINK) {
		OD_PROGRAMlINK = oD_PROGRAMlINK;
	}

	public String getOD_WEEK() {
		return OD_WEEK;
	}

	public void setOD_WEEK(String oD_WEEK) {
		OD_WEEK = oD_WEEK;
	}
	...
	public String getOD_HOSTNAME() {
		return OD_HOSTNAME;
	}

	public void setOD_HOSTNAME(String oD_HOSTNAME) {
		OD_HOSTNAME = oD_HOSTNAME;
	}

	public String getOD_HOSTIMGCLIENTFILE() {
		return OD_HOSTIMGCLIENTFILE;
	}

	public void setOD_HOSTIMGCLIENTFILE(String oD_HOSTIMGCLIENTFILE) {
		OD_HOSTIMGCLIENTFILE = oD_HOSTIMGCLIENTFILE;
	}

	public String getOD_HOSTIMGSERVERFILE() {
		return OD_HOSTIMGSERVERFILE;
	}

	public void setOD_HOSTIMGSERVERFILE(String oD_HOSTIMGSERVERFILE) {
		OD_HOSTIMGSERVERFILE = oD_HOSTIMGSERVERFILE;
	}

	public String getOD_HOSTFB() {
		return OD_HOSTFB;
	}

	public void setOD_HOSTFB(String oD_HOSTFB) {
		OD_HOSTFB = oD_HOSTFB;
	}

	public String getOD_HOSTFANGROUP() {
		return OD_HOSTFANGROUP;
	}

	public void setOD_HOSTFANGROUP(String oD_HOSTFANGROUP) {
		OD_HOSTFANGROUP = oD_HOSTFANGROUP;
	}
