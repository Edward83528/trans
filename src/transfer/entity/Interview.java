...
public class Interview {
	...
	private String OD_SUBJECT; // 標題

	private String OD_STATIONSERNO; // 全國網/分臺代碼

	private LocalDateTime OD_INTERVIEWDATE; // 專訪日期

	private String OD_INTERVIEWUNIT; // 受訪單位

	private String OD_HOST; // 主持人/製播小組

	private String OD_DETAILCONTENT; // 詳細內容
	...
	public LocalDateTime getOD_INTERVIEWDATE() {
		return OD_INTERVIEWDATE;
	}

	public void setOD_INTERVIEWDATE(LocalDateTime oD_INTERVIEWDATE) {
		OD_INTERVIEWDATE = oD_INTERVIEWDATE;
	}

	public String getOD_INTERVIEWUNIT() {
		return OD_INTERVIEWUNIT;
	}

	public void setOD_INTERVIEWUNIT(String oD_INTERVIEWUNIT) {
		OD_INTERVIEWUNIT = oD_INTERVIEWUNIT;
	}

	public String getOD_HOST() {
		return OD_HOST;
	}

	public void setOD_HOST(String oD_HOST) {
		OD_HOST = oD_HOST;
	}
