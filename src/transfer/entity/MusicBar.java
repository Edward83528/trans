...
public class MusicBar {
	...
	private String OD_SECSUBJECT; // 收聽頻道

	private LocalDateTime OD_BROADCASTTIME; // 播出時間

	private String OD_SHOWTIME; // 播出時段

	private String OD_PRODUCTIONUNIT; // 製播單位
	...
	public LocalDateTime getOD_BROADCASTTIME() {
		return OD_BROADCASTTIME;
	}

	public void setOD_BROADCASTTIME(LocalDateTime oD_BROADCASTTIME) {
		OD_BROADCASTTIME = oD_BROADCASTTIME;
	}
	...
	public String getOD_PRODUCTIONUNIT() {
		return OD_PRODUCTIONUNIT;
	}

	public void setOD_PRODUCTIONUNIT(String oD_PRODUCTIONUNIT) {
		OD_PRODUCTIONUNIT = oD_PRODUCTIONUNIT;
	}
